...
<section class="slider-area slider-02 slider-active">
    <div class="single-slider d-flex align-items-center bg_cover" style="background-image: url({{ asset('website') }}/images/slider-2-1.webp);">
        <div class="container">
            <div class="slider-content slider-content-2">
                <h2 class="title" data-animation="fadeInLeft" data-delay="0.2s">Education is the power of Humanity</h2>
                <ul class="slider-btn">
    ...
    <div class="single-slider d-flex align-items-center bg_cover" style="background-image: url({{ asset('website') }}/images/slider-2-2.webp);">
        <div class="container">
            <div class="slider-content slider-content-2">
                <h2 class="title" data-animation="fadeInLeft" data-delay="0.2s">Education is the power of Humanity</h2>
                <ul class="slider-btn">
    ...
    <div class="single-slider d-flex align-items-center bg_cover" style="background-image: url({{ asset('website') }}/images/slider-2-3.webp);">
        <div class="container">
            <div class="slider-content slider-content-2">
                <h2 class="title" data-animation="fadeInLeft" data-delay="0.2s">Education is the power of Humanity</h2>
                <ul class="slider-btn">
