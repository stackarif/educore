    ...
    <div class="container-fluid bg-dark mb-30">
        <div class="row px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a class="btn d-flex align-items-center justify-content-between w-100" data-toggle="collapse" href="#navbar-vertical" style="height: 65px; padding: 0 30px; background-color: #ffd333;">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <a href="{{ route('wishlist') }}" class="btn px-0">
                                ...
                                <span class="badge text-secondary border border-secondary rounded-circle" style="padding-bottom: 2px;">{{ auth('customer')->user()->wishlists->count() }}</span>
                            </a>
                            @endauth
    ...
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                ...
                <p class="mb-4">{{ $webfooter->footer_1 ?? "NULL" }}</p>
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>{{ $webfooter->address ?? "NULL" }}</p>
                <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>{{ $webfooter->email ?? "NULL" }}</p>
                <p class="mb-0"><i class="fa fa-phone-alt text-primary mr-3"></i>{{ $webfooter->phone ?? "NULL" }}</p>
            </div>
            <div class="col-lg-8 col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex">
                            <a class="btn btn-primary btn-square mr-2" href="{{ $webfooter->tw }}"><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-primary btn-square mr-2" href="{{ $webfooter->fb }}"><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-primary btn-square mr-2" href="{{ $webfooter->link }}"><i class="fab fa-linkedin-in"></i></a>
                            <a class="btn btn-primary btn-square" href="{{ $webfooter->ins }}"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                </div>
            </div>
