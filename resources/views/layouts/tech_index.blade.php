...
<html lang="en">
    ...
    <link rel="stylesheet" href="{{ asset('website2') }}/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{ asset('website2') }}/css/bootstrap.css">
    <link rel="stylesheet" href="{{ asset('website2') }}/css/colors.css">
    <link rel="stylesheet" href="{{ asset('website2') }}/css/font-awesome.min.css">
    <link rel="stylesheet" href="{{ asset('website2') }}/css/responsive.css">
    <link rel="stylesheet" href="{{ asset('website2') }}/css/css/version/tech.css">
    <link rel="stylesheet" href="{{ asset('website2') }}/css/style.css">
...
<body>
    ...
    <script src="{{ asset('website2') }}/js/jquery.min.js"></script>
    <script src="{{ asset('website') }}/js/tether.min.js"></script>
    <script src="{{ asset('website') }}/js/bootstrap.min.js"></script>
  
    <script src="{{ asset('website2') }}/js/custom.js"></script>
